...
SECRET_KEY = env(
    "DJANGO_SECRET_KEY",
    default="mCd2OXt93WbUflQr5uzxhfEXihbneG0UoLszAg1ZNcttoQVTIOgHiDzIr1hVSjJv",
)
...
# Use Redis in dev (already running for Celery) so caching behaviour matches production.
CACHES = {
    "default": {
